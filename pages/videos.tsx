          ...
          <div className="videos-grid">
            ...
            <div className="video-card" data-category="tutorials">
              ...
              <div className="video-info">
                <h3 className="video-title">Building Responsive Layouts</h3>
            ...
            <div className="video-card" data-category="creative">
              ...
              <div className="video-info">
                <h3 className="video-title">Creative Animations</h3>
                <p className="video-description">Exploring creative animation techniques with CSS and JavaScript</p>
                <div className="video-meta">
            ...
            <div className="video-card" data-category="projects">
              ...
              <div className="video-info">
                <h3 className="video-title">Games Mini Showcase</h3>
                <p className="video-description">Demo of interactive mini-games collection</p>
                <div className="video-meta">
            ...
            <div className="video-card" data-category="creative">
              ...
              <div className="video-info">
                <h3 className="video-title">UI/UX Design Process</h3>
                <p className="video-description">Behind the scenes of designing user interfaces</p>
                <div className="video-meta">
